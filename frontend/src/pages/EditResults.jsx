            ...
            <div className='flex flex-col item-center m-3 md:flex-row'>
                <div className='w-full border ml-3'>
                    ...
                    <form className='flex flex-col p-2' action="">
                        ...
                        <select class="block appearance-none w-4/5 bg-white border border-gray-200 text-gray-700 m-2 p-2 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" required name='resuts'>
