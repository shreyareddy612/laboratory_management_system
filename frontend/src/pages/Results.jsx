            ...
            <div className='flex flex-col m-3 md:flex-row'>
                <div className='w-full border mr-3 md:w-1/2'>
                    ...
                    <div className='flex flex-col justify-center border items-center p-2 mt-3'>
                        ...
                        <div className='p-2 border m-2'>
                            <h2>Name: <span className='text-green-700'>Mbithi Charles</span></h2>

                            <h2>Test: <span className='text-green-700'>Malaria test</span></h2>

                            <h2>Booking No: <span className='text-green-700'>6426d9ee253aa0c57c50d435</span></h2>
                        </div>
                        {/* START SINGLE TEST CARD */}
                    ...
                    <div className='flex flex-col justify-center border items-center p-2 mt-3'>
                        {/* START SINGLE TEST CARD */}
                        <div className='p-2 border m-2'>
                            <h2>Name: <span className='text-green-700'>Joe Doe</span></h2>

                            <h2>Test: <span className='text-green-700'>Cholera</span></h2>

                            <h2>Booking No: <span className='text-green-700'>6426dae62456bcad1b513b3f</span></h2>
                        </div>
                        {/* START SINGLE TEST CARD */}
                ...
                <div className='w-full border ml-3 md:w-1/2'>
                    ...
                    <form className='flex flex-col p-2' action="">
                        ...
                        <select class="block appearance-none w-4/5 bg-white border border-gray-200 text-gray-700 m-2 p-2 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" required name='test_resuts' >
